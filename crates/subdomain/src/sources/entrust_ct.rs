//! EntrustCt Certificate Transparency log source.
use gossan_core::{Config, DiscoverySource, DomainTarget, Target};
use crate::sources::{SubdomainSource, SourceRate};
use async_trait::async_trait;
use governor::DefaultDirectRateLimiter;

pub struct EntrustCt;

#[async_trait]
impl SubdomainSource for EntrustCt {
    fn name(&self) -> &'static str { "entrust_ct" }
    ...
    async fn query(
        ...
        let url = format!("https://ct.entrust.net/ct/v1/get-entries?domain={}", domain);
