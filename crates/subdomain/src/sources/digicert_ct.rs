//! DigicertCt Certificate Transparency log source.
use gossan_core::{Config, DiscoverySource, DomainTarget, Target};
use crate::sources::{SubdomainSource, SourceRate};
use async_trait::async_trait;
use governor::DefaultDirectRateLimiter;

pub struct DigicertCt;

#[async_trait]
impl SubdomainSource for DigicertCt {
    fn name(&self) -> &'static str { "digicert_ct" }
    ...
    async fn query(
        ...
        let url = format!("https://ct2.digicert.com/log/ct/v1/get-entries?domain={}", domain);
