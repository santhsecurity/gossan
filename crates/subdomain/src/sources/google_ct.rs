//! GoogleCt Certificate Transparency log source.
...
#[async_trait]
impl SubdomainSource for GoogleCt {
    fn name(&self) -> &'static str { "google_ct" }
    ...
    async fn query(
        ...
        let url = format!("https://ct.googleapis.com/logs/argon2025/ct/v1/get-entries?domain={}", domain);
