//! AppleCt Certificate Transparency log source.
...
#[async_trait]
impl SubdomainSource for AppleCt {
    fn name(&self) -> &'static str { "apple_ct" }
    ...
    async fn query(
        ...
        let url = format!("https://ct.apple.com/logs/operational/ct/v1/get-entries?domain={}", domain);
