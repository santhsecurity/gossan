//! IdentrustCt Certificate Transparency log source.
use gossan_core::{Config, DiscoverySource, DomainTarget, Target};
use crate::sources::{SubdomainSource, SourceRate};
use async_trait::async_trait;
use governor::DefaultDirectRateLimiter;

pub struct IdentrustCt;

#[async_trait]
impl SubdomainSource for IdentrustCt {
    fn name(&self) -> &'static str { "identrust_ct" }
    ...
    async fn query(
        ...
        let url = format!("https://ct.identrust.com/logs/ct/v1/get-entries?domain={}", domain);
