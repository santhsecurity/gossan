//! SectigoCt Certificate Transparency log source.
use gossan_core::{Config, DiscoverySource, DomainTarget, Target};
use crate::sources::{SubdomainSource, SourceRate};
use async_trait::async_trait;
use governor::DefaultDirectRateLimiter;

pub struct SectigoCt;

#[async_trait]
impl SubdomainSource for SectigoCt {
    fn name(&self) -> &'static str { "sectigo_ct" }
    ...
    async fn query(
        ...
        let url = format!("https://ct.sectigo.com/logs/ct2025/ct/v1/get-entries?domain={}", domain);
