//! CloudflareCt Certificate Transparency log source.
use gossan_core::{Config, DiscoverySource, DomainTarget, Target};
use crate::sources::{SubdomainSource, SourceRate};
use async_trait::async_trait;
use governor::DefaultDirectRateLimiter;

pub struct CloudflareCt;

#[async_trait]
impl SubdomainSource for CloudflareCt {
    fn name(&self) -> &'static str { "cloudflare_ct" }
    ...
    async fn query(
        ...
        let url = format!("https://ct.cloudflare.com/logs/nimbus2025/ct/v1/get-entries?domain={}", domain);
