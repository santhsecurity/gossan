...
fn main() {
    ...
    if chains.len() == 1 {
        ...
        println!(
            "   Evidence contains finding 1: {} (expected: true)",
            finding_1_in_evidence
        );
        println!(
            "   Evidence contains finding 2: {} (expected: true)",
            finding_2_in_evidence
        );
