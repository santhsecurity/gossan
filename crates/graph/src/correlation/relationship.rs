...
// Re-homed into gossan-graph (C2): these were `gossan_graph::…` when
// correlation was a separate crate; now they are siblings in this crate.
use crate::{schema::EdgeType, schema::NodeType, Edge, Node};
